 ...
 *
 * By Maja Aurora Pieper
 * MIT Licensed.
 */

Module.register("MMM-Mopidy-MPD",{
	...
	getStyles: function() {
        ...
        return ['font-awesome.css','MMM-Mopidy-MPD.css'];
    },
    ...
    socketNotificationReceived: function(notification, payload) {
        ...
        if (notification === 'mpd_playlist_update') {
			...
			this.playListTime = this.getListTime(payload);
			this.loading = false;
        	this.updateDom();
        }
    },
	...
	getTemplate: function () {
        return "templates\\mmm-mopidy-mpd-playlist.njk";
	},
    ...
    getTemplateData: function () {
		...
		if (!this.loading) {
			...
			if(this.playList.length > 0){
				...
				templateData.playlisttime = this.playListTime;
			}
		}
        return templateData;
	},
	...
	getListTime: function(list) {
		var complete = 0;
		for (var x in list) {
			complete = complete + parseInt(list[x].Time);
		}
		return complete;
	},
